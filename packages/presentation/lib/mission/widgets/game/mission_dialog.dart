                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              isCompleted
                                  ? localization.missionSuccessDescription
                                  : localization.missionFailDescription,
                              style: const TextStyle(
                                fontWeight: FontWeight.bold,
                              ),
                            ),
                            if (gameResultError != null)
                              Text(convertProcessGameErrorToString(error: gameResultError, localization: localization)),
                          ],
                        ),
                      ),
                      if (size != null)
